...
import { VENDOR_ADDITIONAL_CONTENT_20260305040000 } from './data/vendor-additional-content-20260305040000.data';
...
export class VendorAdditionalContentImport20260305040000
  implements MigrationInterface
{
  name = 'VendorAdditionalContentImport20260305040000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    for (const payload of VENDOR_ADDITIONAL_CONTENT_20260305040000) {
      const vendorId =
